...
use App\Domains\Booking\Repositories\Interface\BookingCancellationPolicyRepositoryInterface; // تأكد من استيراد الموديل
use App\Models\Resource;
use Illuminate\Foundation\Testing\RefreshDatabase;
use Illuminate\Support\Facades\DB;
use Tests\TestCase;

covers(EloquentBookingCancellationPolicyRepository::class);
