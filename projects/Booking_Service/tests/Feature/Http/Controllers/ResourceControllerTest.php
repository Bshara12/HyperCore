...
class ResourceControllerTest extends TestCase
{
    ...
    public function it_lists_resources_by_project_successfully()
    {
        ...
        $this->app->make('events')->listen(RouteMatched::class, function ($event) {
    ...
    public function it_creates_a_new_resource_successfully()
    {
        ...
        $this->serviceMock
            ...
            ->once()
            ->with(\Mockery::type(ResourceDTO::class))
    ...
    public function it_updates_an_existing_resource_successfully()
    {
        ...
        $this->serviceMock
            ...
            ->once()
            ->with(\Mockery::type(\App\Models\Resource::class), \Mockery::type(ResourceDTO::class))
            ->andReturn($resource);
