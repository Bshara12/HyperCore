...
class ReOrderCollectionItemsRequest extends FormRequest
{
  ...
  public function messages(): array
  {
    return [
      ...
      'items.*.item_id.integer' => 'The item_id must be a valid integer.',
      'items.*.item_id.distinct' => 'Duplicate item_id values are not allowed.',
      'items.*.item_id.exists' => 'One or more item_id values do not exist in the database.', // تم التعديل هنا
