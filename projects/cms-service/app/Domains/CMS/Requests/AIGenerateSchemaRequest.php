...
class AIGenerateSchemaRequest extends FormRequest
{
    public function rules(): array
    {
        return [
            ...
            // Fields
            'custom_data_types.*.fields.*.name' => 'required|string|max:255|regex:/^[a-z][a-z0-9_]*$/',
            'custom_data_types.*.fields.*.type' => 'required|string|in:text,number,boolean,select,file,json,relation',
            'custom_data_types.*.fields.*.required' => 'boolean',
            'custom_data_types.*.fields.*.translatable' => 'boolean',
            'custom_data_types.*.fields.*.validation_rules' => 'nullable|array',
            'custom_data_types.*.fields.*.settings' => 'nullable|array',
