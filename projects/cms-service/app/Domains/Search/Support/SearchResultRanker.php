...
{
    private const AFFINITY_WEIGHT = 6.0;
    ...
    private function computeScore(
        ...
        // ─── H. Data-Type Affinity Boost (Personalization) ────────────
        $affinity = $preference->affinityFor((int) $row->data_type_id);

        if ($affinity > 0.0) {
            $score += $affinity * self::AFFINITY_WEIGHT;
        }
